...
int main()
{
    ...
    for (i=1; i<=50;){
        ...
        if(mesa_fumantes>=1 && mesa_nao_fumantes==0){
          printf("\nBom dia, temos %d mesas para fumantes disponíveis. Tecle 1 se deseja reservar uma mesa para fumantes\n", mesa_fumantes);
          scanf("%d", &tecla);
          if (tecla==1){
            printf("\nA opção escolhida foi mesa para fumantes. Obrigado pela preferência.\n");
            mesa_fumantes=mesa_fumantes-1;
        ...
        if(mesa_fumantes==0 && mesa_nao_fumantes>=1){
          printf("\nBom dia, temos %d mesas para não fumantes disponíveis. Tecle 2 se deseja reservar uma mesa para não fumantes.\n", mesa_nao_fumantes);
          scanf("%d", &tecla);
          if (tecla==2){
            printf("\nA opção escolhida foi mesa para não fumantes. Obrigado pela preferência.\n");
            mesa_nao_fumantes=mesa_nao_fumantes-1;
