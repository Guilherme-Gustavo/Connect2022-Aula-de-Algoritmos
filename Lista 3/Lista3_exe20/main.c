...
int main()
{
    ...
    while (i==1){
        ...
        if (codigo_animal==1)
            ...
            numero_cachorros+=1;
        printf("\nInforme o número 1 se ainda possui animais a cadastrar e 0 se terminou o cadastro:\n");
        scanf("%d", &i);
    }
    printf("O número total de gatos é de %d e o número total de cachorros é de %d, totalizando %d animais na loja.", numero_gatos, numero_cachorros, numero_cachorros+numero_gatos);
